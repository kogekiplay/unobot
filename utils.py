...
def display_color(color):
    ...
    if color == "r":
        return _("{emoji} 红色").format(emoji='❤️')
    if color == "b":
        return _("{emoji} 蓝色").format(emoji='💙')
    if color == "g":
        return _("{emoji} 绿色").format(emoji='💚')
    if color == "y":
        return _("{emoji} 黄色").format(emoji='💛')


def display_color_group(color, game):
    """ Convert a color code to actual color name """
    if color == "r":
        return __("{emoji} 红色", game.translate).format(
            emoji='❤️')
    if color == "b":
        return __("{emoji} 蓝色", game.translate).format(
            emoji='💙')
    if color == "g":
        return __("{emoji} 绿色", game.translate).format(
            emoji='💚')
    if color == "y":
        return __("{emoji} 黄色", game.translate).format(
            emoji='💛')
